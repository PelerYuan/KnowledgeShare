"""
URL configuration for KnowledgeShare project.
...
urlpatterns = [
    ...
    #         name='password_reset'),
    # edit back later
    re_path(r'^reset/$', accounts_views.password_reset_notification, name='password_reset'),
    ...
    re_path(r'^settings/account/$', accounts_views.user_update_view, name='my_account'),
    ...
    re_path(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/posts/(?P<post_pk>\d+)/delete/$',
            views.PostDeleteView.as_view(), name='delete_post'),
    re_path(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/posts/(?P<post_pk>\d+)/download/$',
            views.PostDownloadView.as_view(), name='download_post'),
